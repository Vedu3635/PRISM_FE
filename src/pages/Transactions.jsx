...
const TransactionRow = ({ merchant, sub, amount, date, category, status, onDelete }) => {
  ...
  return (
    <div className="group flex items-center gap-4 p-3 rounded-lg hover:bg-surface-container-high transition-colors cursor-pointer border border-transparent">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[10px] text-on-surface-variant truncate mt-0.5">{sub}</p>
      </div>
...
const Transactions = () => {
  ...
  const transactions = [
    { merchant: 'AWS Cloud Services', sub: 'Recurring Infrastructure', category: 'Technology', date: 'Oct 24, 2024', amount: -14200.50 },
    { merchant: 'Capital Partners', sub: 'Portfolio Yield', category: 'Investment', date: 'Oct 23, 2024', amount: 42500.00 },
    { merchant: 'Metropolitan Real Estate', sub: 'Quarterly Lease', category: 'Fixed Assets', date: 'Oct 20, 2024', amount: -68000.00 },
    { merchant: 'Lufthansa First Class', sub: 'Business Travel', category: 'Travel', date: 'Oct 18, 2024', amount: -8450.00 },
    { merchant: 'Nobu Fifty Seven', sub: 'Client Hospitality', category: 'Dining', date: 'Oct 15, 2024', amount: -1240.35 },
    { merchant: 'Apple Corp', sub: 'Tech & Hardware', category: 'Technology', date: 'Oct 12, 2024', amount: -2899.00 },
    { merchant: 'Vanguard Global', sub: 'Dividends', category: 'Investment', date: 'Oct 10, 2024', amount: 15600.25 },
  ];
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="p-5 rounded-xl border border-primary/20 bg-primary/5 flex flex-col md:flex-row items-start md:items-center gap-4">
        ...
        <div className="flex-1">
           <h3 className="text-sm font-semibold text-white mb-1">Anomalous spend detected in Technology</h3>
           <p className="text-xs text-on-surface-variant">
             Infrastructure costs increased by <span className="text-primary font-semibold">14.2%</span> compared to your 3-month average. Recommend reviewing AWS resource allocations.
           </p>
        </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
         ...
         <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="w-48">
               <PRISMSelect 
                  options={['All Flows', 'Recurring', 'Capital', 'Merchant', 'Hospitality']} 
                  value={filter}
                  onChange={setFilter}
               />
            </div>
      ...
      <div className="bg-surface-container border border-white/5 rounded-xl overflow-hidden">
         <div className="p-5 border-b border-white/5 flex items-center justify-between bg-surface-container-low">
            <div>
               <p className="text-sm font-semibold text-white">482 Total Records Synced</p>
            </div>
         ...
         <div className="bg-surface-container-low p-4 flex justify-between items-center sm:px-6 border-t border-white/5">
            <p className="text-xs text-on-surface-variant font-medium">Showing 1-7 of 482 transactions</p>
